...
public class ComputerManagerTests {
    ...
    public  void setUp (){
        ...
        computer = new Computer("Samsung", "B34567", 300.00);
    ...
    public void testGet2(){
        this.computerManager.getComputer("test_mul", null);
    }
    ...
    public void testGetByMan(){
        ...
        assertNotNull(list.get(0).getManufacturer(),computer.getManufacturer());
    }
